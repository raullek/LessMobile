...
import lessmobile.composeapp.generated.resources.saved_not_logged_in_description
import lessmobile.composeapp.generated.resources.saved_not_logged_in_title
import lessmobile.composeapp.generated.resources.saved_sign_in
import org.jetbrains.compose.resources.painterResource
import org.jetbrains.compose.resources.stringResource

@Composable
fun FavoritesNotLoggedInState(
    onSignInClick: () -> Unit,
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.saved_not_logged_in_title),
        ...
        Text(
            text = stringResource(Res.string.saved_not_logged_in_description),
        ...
        DsButton(
            text = stringResource(Res.string.saved_sign_in),
