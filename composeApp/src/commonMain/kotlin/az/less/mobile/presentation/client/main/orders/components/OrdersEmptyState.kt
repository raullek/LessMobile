...
import lessmobile.composeapp.generated.resources.orders_empty_title
import lessmobile.composeapp.generated.resources.orders_empty_description
import lessmobile.composeapp.generated.resources.orders_explore_offers
...
fun OrdersEmptyState(
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.orders_empty_title),
        ...
        Text(
            text = stringResource(Res.string.orders_empty_description),
        ...
        DsButton(
            text = stringResource(Res.string.orders_explore_offers),
